...
/*   Updated: 2017/12/18 14:58:16 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** DESCRIPTION
**	- The ft_isalnum function tests if the interger c is an alphabetic or
**	numeric character.
...
**
** RETURN VALUES
**	- ft_isalnum returns 1 if the test is true or 0 if test is false.
*/
