...
/*   Updated: 2018/02/09 14:53:15 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** DESCRIPTION
**	- The ft_isgraph function tests if the integer c is a printable character
**	except space (' ').
...
**
** RETURN VALUES
**	- ft_isgraph returns 1 if the test is true or 0 if the test is false.
*/
