...
/*   Updated: 2018/02/09 15:15:09 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** DESCRIPTION
**	- The ft_str_isprint function tests if the string str is full of
...
**
** RETURN VALUES
**	- ft_str_isprint returns 1 if the test is true or 0 if the test is false.
*/
