...
/*   Updated: 2018/02/09 14:57:19 by lbrangie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** DESCRIPTION
**	- The ft_isprint function tests if the integer c is a printable character
**	including space (' ').
...
**
** RETURN VALUES
**	- ft_isprint returns 1 if the test is true or 0 if the test is false.
*/
